        ...
        <table className={styles.groupsTable}>
          ...
          <tbody>
            {groups?.map((group: any, index: number) => {
              const RolesData = ['Sas', 'saas','sas'].includes(group.group.group_type) ? sassRoles : DadboxRoles
              ...
              return (
                <tr key={group?.id}>
                  ...
                  <td>{['Sas', 'saas','sas'].includes(group.group.group_type) ? 'SAS' : group.group.group_type}</td>
